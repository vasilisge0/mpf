...
filename_A_array=("banded_covariance/dataset_uncov_128_128_3_5_A.mtx")
filename_out="dataset_uncov_128_128_3_5_A.txt"
blk_fA_array=(2)
...
echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
echo "echo mpf_application_06_uncov.sh"
echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
...
out_path="${mpf_out}/index_by_application/mpf_application_06_uncov"
out_path_approx="${mpf_out}/index_by_application/mpf_application_06_uncov/approx"
out_path_log="${mpf_out}/index_by_application/mpf_application_06_uncov/log"
out_path_plots="${mpf_out}/index_by_application/mpf_application_06_uncov/plots"
...
for i_output_type in $(seq 1 ${#output_type_array[@]})
do
                    ...
                    do
                      ...
                      do
                        ...
                        do
                          ...
                          file+="_"
                          file+="${output_type_array[$i_output_type-1]}"
                          file+="_"
                          ...
                          $mpf_lib"/mpf_application_06_uncov"\
                          ${blk_fA_array[$i0-1]}\
                          ${output_type_array[$i_output_type-1]}\
...
#cd '../../matlab/analysis/examples/index_by_application/'
#matlab -nodesktop -r ./mpf_application_06
