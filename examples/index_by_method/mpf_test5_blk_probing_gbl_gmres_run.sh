...
filename_bash_log="test5_blk_probing_gbl_gmres_nn_bash_log"
        ...
        do
          ...
          do
            ...
            do
              ...
              do
                for i8 in $(seq $i8_start ${#solver_inner_restarts_array[@]})
                do
                  file="test5_blk_probing_gbl_gmres_nn"
                  file+="_"
                  ...
                  $mpf_lib"/mpf_test5_blk_probing_gbl_gmres"\
                  ${blk_fA_array[$i0-1]}\
                  $mpf_data"/"$filename_A\
                  ...
                  ${solver_inner_restarts_array[$i8-1]}
                  ...
                  file_bash_log+=${solver_inner_nthreads_array[@]}"\n""none\n""none\n""cg\n"${solver_inner_tol_array}"\n"
                  file_bash_log+=${solver_inner_iters_array[@]}"\n"
                  file_bash_log+=${solver_inner_restarts_array[@]}"\n"
                  file_bash_log+=${configuration[@]}
