...
# 
#"dataset_lapl_128_128_2_sym_A.mtx"

filename_A_array=("dataset_uncov_256_256_3_5_A_sym.mtx")
...
echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
echo "echo mpf_test6_blk_probing_cg_spai_run.sh"
echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
        ...
        do
          ...
          do
            ...
            do
              ...
              do
echo "iters length: ${#solver_inner_iters_array[@]}"
                for i7 in $(seq $i7_start ${#solver_inner_iters_array[@]})
                do
                  filename_bash_log="test6_blk_cg_nn_bash_log_$iA"

                  file="test6_blk_cg_nn_spai"
                  file+="_"
                  ...
                  $mpf_lib"/mpf_test6_blk_probing_cg_spai"\
                  ${blk_fA_array[$i0-1]}\
                  ...
                  file_bash_log+=${solver_inner_iters_array[@]}"\n"
                  file_bash_log+=${configuration[@]}
                  echo "writting to file:" ${filename_bash_log[@]}
